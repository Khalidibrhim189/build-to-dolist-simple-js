...
function submitToDo(){
    ...
    node0.setAttribute("style", "border-box:5px; padding:15px 10px 5px 20px; color:#434a54; margin-top:10px font-size:25px; overflow:hidden;" );
...
function random_color(){
    var random_color = [
        'rgb(224,242,23)','rgb(206,181,167)','rgb(161,124,107)','rgb(91,123,122)','rgb(60,136,126)'
    ];
